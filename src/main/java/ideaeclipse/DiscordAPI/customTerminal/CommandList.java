...
public class CommandList {
    ...
    public CommandList(final String commandDirectory, final String genericDirectory) {
        try {
            commandMap = getClasses(commandDirectory);
            genericCommandMap = getClasses(genericDirectory);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
